...
? Hay pruebas unitarias, pruebas funcionales, pruebas de integración, pruebas de aceptación.
? La lista es casi interminable.
? Vamos a centrarnos en las pruebas unitarias: 

> Pruebas que cubren una parte específica del código, como una función o un método.
